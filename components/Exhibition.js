...
export default () => {
    ...
    <div className='-z-0 h-fit w-fit min-w-full bg-hero bg-repeat bg-local bg-20%'>
        <div className=' py-10 text-center ml-auto mr-auto block'>
                ...
                <div className="py-3 text-3xl UrbanistFont.localFont text-center"></div>
                <div className="text-1xl UrbanistFont.localFont italic text-center">Coming Soon: Spotlight Etiquette (Album)</div>
                ...
                <Link href="/Ghost-Girl">
                    ...
                    width={400}
                    height={400}
                    className=" scale-90 block transition-all hover:scale-100 hover:hidden hover:duration-100"
                    >
                    </Image>
                </Link>
                ...
                {/* A Bell A/Bove Yelling */}
                <Link href="/A-Bell-A-Bove-Yelling">
                    <Image 
                ...
                <div className="scale-95 py-3 text-3xl UrbanistFont.localFont text-center">A Bell A/Bove Yelling - Exhibit6333</div>
