...
export default () => {
    ...
    return (
      ...
      <div className='z-10 bg-stone-500 py-6 text-center'>
        <div>
            <ul>
                <li className={currentRoute === '/' ? 'px-10 inline text-3xl text-gray-300 font-semibold UrbanistFont.localFont' : 'px-10 inline text-3xl UrbanistFont.localFont text-neutral-400 hover:text-neutral-600 hover:font-semibold'}>
